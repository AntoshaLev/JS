let arrProdName = ["Iphone", "Samsung", "Macbook", "Apple watch", "Робот пылесос", "Фен", "Самокат"];
let arrColor = ["red", "blue", "yellow", "green", "black", "aqua", "azure"];
...
for (var i = 0; i < 7; i++) {
    prodPrice = Math.round(Math.random() * 50000);
